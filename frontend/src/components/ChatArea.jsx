  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      const assistantMsg = {
        ...
        role: 'assistant',
        content: data.answer || 'No answer generated.',   // ← use Gemini answer
        chunks: data.chunks || [],                         // ← keep sources
        created_at: new Date().toISOString()
      };
              ...
              <div className="message-bubble">
                ...
                <div className="message-content-box" style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--text-muted)' }}>
                  <Loader2 size={15} className="spinner" />
                    <span style={{ fontSize: '14px' }}>Thinking...</span>                </div>
              </div>
            </div>
          )}
      ...
      <div className="chat-input-container">
        <div className="chat-input-bar">
          ...
          <div className="chat-input-footer-text">
            Answers are generated by Gemini using retrieved code from ChromaDB. Always verify important details.
          </div>
        </div>
      </div>
    </div>
